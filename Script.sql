--Задание 1. Вывести все параметры, относящиеся к покупкам, которые совершал Calvin Potter
...
--Задание 2.Посчитать средний чек покупателей по дням
...
--Задание 3.Преобразуйте дату транзакции в нужный формат: год, месяц, день. 
...
--Задание 4.Сделать анализ покупателей и разделить их по категориям. 
...
--Задание 5. Посчитать количество уникальных посетителей в каждом магазине каждый день
...
--Задание 6.Посчитать количество клиентов по поколениям
...
--Задание 9. Соберите витрину из следующих полей
--Transaction_date, sales_outlet_id, store_address, product_id, 
--product_name, customer_id, customer_name, gender (заменить на Male, Female, Not Defined если пустое значение), 
--unit_price, quantity, line_item_amount
